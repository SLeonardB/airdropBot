...
async def airdrop(update, context):
    await update.message.reply_text(
            ...
            Receive free airdrop and centidrop(tenth an airdrop) when you refer a user.
            Refer more users to receive more centidrops.
            Referred users must join for you to receive free drops.
            """)
